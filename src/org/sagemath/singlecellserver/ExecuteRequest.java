...
import org.sagemath.droid.models.Request;
import org.sagemath.droid.models.Request.RequestContent;
...
public class ExecuteRequest extends CommandRequest {
    ...
    public Request getExecuteRequest() {
        Header header = getBaseHeader();

        RequestContent content = new RequestContent();
        content.setCode(input);
        content.setSilent(false);
        content.setAllowStdin(false);
